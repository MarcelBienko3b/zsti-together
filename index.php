    ...
    <body>
        ...
        <nav class="navbar navbar--horizontal">
            <ul class="navbar__list">
                <li class="navbar__item"><a href="register.php">Zarejestruj się</a></li>
                <li class="navbar__item"><a href="loginStudent.php">Zaloguj się jako uczeń</a></li>
                <li class="navbar__item"><a href="loginTeacher.php">Zaloguj się jako nauczyciel</a></li>
            </ul>
        </nav>
